        ...
        <div className="container mx-auto max-w-4xl relative">
          ...
          <div className="mb-12 w-full max-w-2xl mx-auto rounded-2xl bg-white p-1 shadow-xl relative z-10 overflow-hidden">
            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-blue-100">
              ...
              {/* Seção "Ao finalizar o quiz" - MELHORADA */}
              <div className="bg-gradient-to-r from-amber-50 to-yellow-50 p-6 rounded-xl mb-8 border border-amber-200 shadow-md relative overflow-hidden">
                ...
                <div className="flex items-center justify-center mb-4">
                  ...
                  <h4 className="text-xl font-bold text-amber-700">Ao finalizar o quiz você receberá:</h4>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 mb-4 shadow-sm border border-amber-100 relative">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h5 className="font-bold text-blue-700 mb-1">Guia Exclusivo para Pais</h5>
                      <p className="text-sm text-gray-600">
                        Um guia completo com <span className="font-semibold">5 estratégias práticas</span> para ensinar
                        histórias bíblicas de forma divertida e memorável para crianças de todas as idades.
                      </p>
                      <div className="mt-2 flex flex-wrap gap-2">
                        <span className="bg-blue-50 text-blue-600 text-xs px-2 py-1 rounded-full">PDF Ilustrado</span>
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm border border-amber-100 relative">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h5 className="font-bold text-amber-700 mb-1">Oferta Imperdível</h5>
                      <p className="text-sm text-gray-600">
                        Acesso com <span className="font-semibold">desconto exclusivo</span> ao Kit da Criança Cristã,
                        com materiais educativos e divertidos para fortalecer a fé dos seus filhos.
                      </p>
                      <div className="mt-2 flex flex-wrap gap-2">
              ...
              <h4 className="text-lg font-bold text-blue-700 mb-3 text-center">Além disso, você também vai:</h4>
              <ul className="space-y-4 mb-6">
                <li className="flex items-center bg-blue-50 p-3 rounded-lg">
                  <Check className="mr-3 h-6 w-6 text-green-500 flex-shrink-0" />
                  <span>Descobrir o quanto você sabe sobre a Bíblia de forma divertida</span>
                </li>
                <li className="flex items-center bg-purple-50 p-3 rounded-lg">
                  <Check className="mr-3 h-6 w-6 text-green-500 flex-shrink-0" />
                  <span>Aprender formas criativas de ensinar histórias bíblicas para seus filhos</span>
                </li>
                <li className="flex items-center bg-green-50 p-3 rounded-lg">
                  <Check className="mr-3 h-6 w-6 text-green-500 flex-shrink-0" />
                  <span>Criar momentos especiais de conexão familiar através da fé</span>
                </li>
              </ul>
          ...
          {/* Depoimento */}
          <div className="mb-12 w-full max-w-2xl mx-auto rounded-lg bg-blue-100 p-6 shadow-md text-center">

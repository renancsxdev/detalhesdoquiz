  ...
  try {
    initializeApp({
      credential: cert({
        ...
        clientEmail: process.env."firebase-adminsdk-fbsvc@kit-cristao.iam.gserviceaccount.com" || "",
        privateKey: (process.env."e4e237d90d1023a31f790ef553c25c242ae19694" || "").replace(/\\n/g, "\n"),
      }),
    })
  } catch (error) {
